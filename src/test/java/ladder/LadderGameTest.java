...
class LadderGameTest {
    ...
    void 사다리_생성_확인() {
        //given
        NaturalNumber numberOfRow = NaturalNumber.numberOfRowOf(3);
        NaturalNumber numberOfPerson = NaturalNumber.numberOfPersonOf(5);
    ...
    void 사다리_시작위치_예외_처리() {
        ...
        NaturalNumber numberOfRow = NaturalNumber.numberOfRowOf(1);
        LadderCreator ladderCreator = new LadderCreator(numberOfRow, numberOfPerson);
    ...
    void 사다리_결과_확인() {
        //given
        NaturalNumber numberOfPerson = NaturalNumber.numberOfPersonOf(4);
        NaturalNumber numberOfRow = NaturalNumber.numberOfRowOf(4);
