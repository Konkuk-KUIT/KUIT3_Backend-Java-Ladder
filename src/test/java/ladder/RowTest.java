...
class RowTest {
    ...
    void 참여자_한_명_사다리_이동() {
        ...
        //then
        assertEquals(0, row.nextPosition(Position.of(position));
    }
    ...
    void 참여자_두_명_사다리_열간_이동() {
        ...
        //when
        int position = 0;
        int resultPosition = row.nextPosition(Position.of(position)).get();
        //then
        ...
        //when
        position = 1;
        resultPosition = row.nextPosition(Position.of(position)).get();
        //then
